...
export default function StepEducation({ entries, onChange, add, remove }) {
  ...
  const handlePercentage = (idx, value) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {entries.map((e, idx) => (
        ...
        <div
          key={idx}
          className="p-4 border shadow-sm rounded-2xl space-y-4"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                value={e.degree || ""}
                onChange={(ev) =>
                  onChange(idx, "degree", ev.target.value)
                }
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                value={e.university || ""}
                onChange={(ev) =>
                  onChange(idx, "university", ev.target.value)
                }
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="text-xs inline-flex items-center gap-2 cursor-pointer">
                  ...
                  <input
                    ...
                    onChange={(ev) =>
                      toggleCurrent(idx, ev.target.checked)
                    }
                  />
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                value={e.percentage || ""}
                onChange={(ev) =>
                  handlePercentage(idx, ev.target.value)
                }
